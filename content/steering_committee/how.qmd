...
Please see [the membership page](../steering_committee/who.qmd#membership) for information on what a Steering Committee member is responsible for doing when they are no longer able to serve on the committee.
...
This Code of Conduct is an abbreviated version of [the `asar` code of conduct](https://github.com/nmfs-ost/asar/blob/main/CODE_OF_CONDUCT.md), which was adapted from the [Contributor Covenant][homepage], version 2.1, available at <https://www.contributor-covenant.org/version/2/1/code_of_conduct.html>.
