...
The Steering Committee serves as an advisory group to provide strategic guidance, feedback, and expertise on workflows related to stock assessment at NOAA Fisheries. The committee's primary role is to ensure that the development and implementation of reproducible workflows align with the needs and priorities of NOAA Fisheries Science Centers and offices.
...
Please see [the membership section](../steering_committee/who.qmd#membership) for information on what a Steering Committee member is responsible for doing when they are no longer able to serve on the committee.

# Governance

In this guidebook, we want to explicitly define our governance structure to reduce issues in power imbalances, establish consistent decision-making processes, and  establish clear roles and accountability for both the Steering Committee and Workflows Team.
...
This Code of Conduct is an abbreviated version of [the {asar} code of conduct](https://github.com/nmfs-ost/asar/blob/main/CODE_OF_CONDUCT.md), which was adapted from the [Contributor Covenant](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html), version 2.1.
...
The Workflows Team is actively working on adding more opportunities for Steering Committee members to get involved in the project through the use of detailed and actionable GitHub issues on the repositories page. Please see the [{stockplotr} issues page](https://github.com/nmfs-ost/stockplotr/issues) or [{asar} issues page](https://github.com/nmfs-ost/asar/issues) for potential tasks, and our [contributions guide](https://github.com/nmfs-ost/asar/blob/main/CONTRIBUTING.md), if you are interested in contributing.
