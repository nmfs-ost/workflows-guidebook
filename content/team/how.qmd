...
When creating a new GitHub project, there are tasks specfic to each package. In the case a feature or task is relevant to each package, then the task is duplicated. Descriptions and relevant information is added to each task. The team will then prioritize the tasks and assign them to team members. The team will also add target dates and milestones to each task. 
